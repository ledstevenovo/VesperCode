...
**SPEC scope:** SPEC §0.1 `CanonicalRelativePathV1`; §1.4.3; §4.1 behavior 6–10; §4.3 behavior 4–5; §5.2; §5.5; §10.1 AC-01, AC-15, AC-21, AC-26, AC-31; §10.3 Windows integration; §11.2 item 1.

**Executable children:** 1.A, 1.B, 1.C, 1.D, 1.E

**Aggregate completion condition:** All listed children are completed according to the canonical DAG, and all child-owned verification and review gates have passed. Task 1.E records the required terminal `GO`; `NO_GO` leaves this Milestone incomplete. This Milestone is descriptive/aggregate only and owns no files, APIs, dependencies, schedule, branch/worktree, status, implementation, tests, verification procedure, review procedure, or evidence.
...
**SPEC scope:** SPEC §1.4.1 `ReferenceProfileManifestV1`; §1.4.5; §4.1 behavior 11–13; §4.5; §5.5; §8.2; §8.4; §10.1 AC-04, AC-19, AC-20, AC-24, AC-25, AC-30; §10.3 Docker integration; §11.2 item 2.

**Executable children:** 2.A, 2.B, 2.C, 2.D, 2.E, 2.F, 2.G

**Aggregate completion condition:** All listed children are completed according to the canonical DAG, and all child-owned verification and review gates have passed. Task 2.G records the required terminal `GO`; `NO_GO` leaves this Milestone incomplete. This Milestone is descriptive/aggregate only and owns no files, APIs, dependencies, schedule, branch/worktree, status, implementation, tests, verification procedure, review procedure, or evidence.
...
**SPEC scope:** SPEC §1.4.4; §4.2.6 deadline rules; §4.6; §5.2; §5.5; §5.6; §10.1 AC-07, AC-21, AC-22, AC-29, AC-31; §10.3 recovery fault injection; §11.2 item 3.

**Executable children:** 3.A, 3.B, 3.C, 3.D, 3.E, 3.F, 3.G

**Aggregate completion condition:** All listed children are completed according to the canonical DAG, and all child-owned verification and review gates have passed. Task 3.G records the required terminal `GO`; `NO_GO` leaves this Milestone incomplete. This Milestone is descriptive/aggregate only and owns no files, APIs, dependencies, schedule, branch/worktree, status, implementation, tests, verification procedure, review procedure, or evidence.
...
**SPEC scope:** SPEC §0; §0.1 and CTV-01–CTV-07; §5.2; §9; §10.1 AC-10 and AC-26; course requirements §3.6, §4.8, §5; `AGENTS.md` build/test, TDD, and credential-scan rules.

**Executable children:** 4.A, 4.F, 4.B, 4.C, 4.D, 4.E
...
**SPEC scope:** SPEC §0.1 closed-schema rules; §4.2.1–§4.2.2 shared status/action contracts; §4.4.3–§4.4.4 location/source unions; §7 data model; §10.1 AC-17, AC-26, AC-27, AC-28.

**Executable children:** 5.A, 5.B, 5.C, 5.D, 5.E
...
**SPEC scope:** SPEC §1.4.1; §4.1 input and behavior 1–4; §4.4.3 endpoint/profile fields; §5.2; §7 profile/config rows; §8.2; §9; §10.1 AC-13, AC-15, AC-26, AC-30, AC-31.

**Executable children:** 6.A, 6.B, 6.C, 6.D, 6.E
...
**SPEC scope:** SPEC §4.2.1; §4.2.7; §4.7 audit ordering; §5.2; §5.4; §5.6; §7 complete data model and storage split; §10.1 AC-16, AC-21, AC-27, AC-28.

**Executable children:** 7.A, 7.B, 7.C, 7.D
...
**SPEC scope:** SPEC §4.1 FR-ADM in full; §4.2.7 lifecycle entry; §5.1; §5.3; §10.1 AC-15, AC-16, AC-21, AC-26, AC-28, AC-30, AC-31.

**Executable children:** 8.A, 8.B
...
**SPEC scope:** SPEC §0.1 path identity; §1.4.1 Git rules; §1.4.2–§1.4.4; §4.1 behavior 6–10; §4.3 behavior 4–5; §4.6 ACL/lease requirements; §5.5; §10.1 AC-01, AC-15, AC-21, AC-26, AC-29, AC-31.

**Executable children:** 9.A, 9.B, 9.C, 9.D
...
**SPEC scope:** SPEC §1.4.1 `StaticProjectProfileCheckV1`; §1.4.4; §4.1 behavior 8–10; §4.2.2 `SupportedTextFileV1`; §4.3 behavior 1–3; §7 Snapshot/List entry rows; §10.1 AC-04, AC-15, AC-17, AC-18, AC-26, AC-31.

**Executable children:** 10.A, 10.B, 10.C
...
**SPEC scope:** SPEC §4.2.2 file actions/results and `SupportedTextFileV1`; §4.2.8; §4.3 input/behavior 2–5; §5.1; §7 `RepositoryLocationV1`/`ListFilesEntryV1`; §10.1 AC-01, AC-17, AC-26, AC-31; §10.3 offline core tests.

**Executable children:** 11.A, 11.B
...
**SPEC scope:** SPEC §1.4.2–§1.4.4; §4.2.2 `ApplyCandidatePatchAction`; §4.3 in full; §4.4.1 path-policy binding; §4.5 pre-check policy revalidation; §7 Candidate/FinalDiff rows; §10.1 AC-01, AC-04, AC-07, AC-18, AC-26, AC-31.

**Executable children:** 12.A, 12.B, 12.C, 12.D
...
**SPEC scope:** SPEC §4.2.7 final-writeback wait; §4.4.1–§4.4.2; §4.6 writeback preconditions; §5.2; §7 subject/approval rows; §10.1 AC-02, AC-03, AC-06, AC-07, AC-27, AC-31.

**Executable children:** 14.A, 14.B, 14.C
...
**SPEC scope:** SPEC §4.2.7 disclosure wait; §4.4.3–§4.4.4 source/scope/budget contracts; §5.1–§5.2; §5.5–§5.6; §7 disclosure rows; §10.1 AC-13, AC-26, AC-27, AC-28.

**Executable children:** 15.A, 15.B, 15.C, 15.D, 15.E, 15.F
...
**SPEC scope:** SPEC §4.2.1; §4.2.5; §4.2.8 LLM errors; §4.4.3–§4.4.4 prepared request/call sequence; §5.1–§5.2; §5.5; §7 LLM rows; §9 LLM choice; §10.1 AC-05, AC-13, AC-26, AC-28.

**Executable children:** 16.A, 16.B
...
**SPEC scope:** SPEC §4.2.1–§4.2.3; §4.2.5 behavior 3–5; §4.2.8; §4.3 candidate binding; §4.4.1; §5.1–§5.2; §7 ActionRecord; §10.1 AC-02, AC-06, AC-17, AC-18, AC-26, AC-28, AC-31.

**Executable children:** 17.A, 17.B, 17.C
...
**SPEC scope:** SPEC §1.4.1 runtime compatibility; §1.4.5; §4.1 readiness; §4.3 cleanup; §4.5 adapter/check execution; §5.1; §5.5; §8.2; §10.1 AC-04, AC-19, AC-20, AC-24, AC-25, AC-30; §10.3 Docker integration.

**Executable children:** 18.A, 18.B, 18.C, 18.D
...
**SPEC scope:** SPEC §1.4.1 runtime compatibility; §4.5 `PytestEvidenceV1`, fingerprint, check execution, errors, and deterministic tests; §5.2; §5.5 trust assumption; §7 evidence rows; §10.1 AC-19, AC-20, AC-24, AC-25, AC-26.

**Executable children:** 19.A, 19.B, 19.C
...
**SPEC scope:** SPEC §1.4.1 `PythonProjectProfileV1`, static detection, runtime compatibility; §4.1 behavior 9–13; §4.5 adapter boundary, baseline, Manifest, errors/tests; §5.1–§5.2; §7 static/runtime/Manifest rows; §10.1 AC-04, AC-15, AC-19, AC-20, AC-25, AC-26, AC-30–AC-31.

**Executable children:** 20.A, 20.B
...
**SPEC scope:** SPEC §4.2.3 formal-validation phase; §4.2.5 completion; §4.3 candidate identity; §4.4.2 final subject inputs; §4.5 check execution and formal success predicate; §4.6 writeback inputs; §7 VerifiedCandidate; §10.1 AC-03–AC-07, AC-18, AC-20, AC-26–AC-28, AC-31.

**Executable children:** 21.A, 21.B, 21.C
...
**SPEC scope:** SPEC §4.2.4 context memory; §4.7 memory write/selection/clear; §5.2; §5.4; §5.6; §7 MemoryEntry; §10.1 AC-14, AC-23, AC-26; §10.3 offline tests.

**Executable children:** 22.A, 22.B, 22.C
...
**SPEC scope:** SPEC §4.7 audit; §5.3–§5.6; §7 AuditEvent; §8.4 evidence separation; §10.1 AC-08, AC-13, AC-16, AC-21–AC-24, AC-27–AC-29; §10.3 evidence matrix.

**Executable children:** 23.A, 23.B, 23.C
...
**SPEC scope:** SPEC §4.2.4–§4.2.6; §4.4.4 source segments; §4.5 structured feedback; §5.1–§5.2; §5.5 disclosure isolation; §7 FeedbackRecord; §10.1 AC-05, AC-13–AC-14, AC-17, AC-26, AC-28.

**Executable children:** 24.A, 24.B, 24.C
...
**SPEC scope:** SPEC §3.2 dimensions; §4.2 in full; §4.4.4 call ordering; §4.5 feedback/formal transition; §5.1–§5.4; §7 AgentTurn/Action/Feedback; §9 LLM boundary; §10.1 AC-02, AC-05–AC-06, AC-13, AC-15–AC-18, AC-20, AC-27–AC-28, AC-31; Harness requirement prohibiting high-level agent executors.

**Executable children:** 25.A, 25.B, 25.C, 25.D, 25.E, 25.F, 25.G
...
**SPEC scope:** SPEC §4.1 OpenAI readiness; §4.8 in full; §5.5 credential threat; §5.6; §8.1; §8.2; §10.1 AC-08, AC-13, AC-15, AC-24, AC-28; §10.3 Windows integration.

**Executable children:** 27.A, 27.B
...
**SPEC scope:** SPEC §2 US-01, US-03–US-06, US-08; §4.2.7 waits; §4.4.2–§4.4.3 UI disclosures; §4.6 writeback review; §4.9 local run capabilities; §5.3–§5.5; §8.2; §10.1 AC-03, AC-06–AC-07, AC-13, AC-15–AC-16, AC-21, AC-27–AC-28, AC-31.

**Executable children:** 29.A, 29.B, 29.C
...
**SPEC scope:** SPEC §1.4 reference profile; §2 US-01 and US-03–US-08; §4.1–§4.8; §5.1–§5.6; §6.2; §7; §10.1 AC-01–AC-08, AC-13–AC-31; §10.3 reference fixture E2E; course repeatable mechanism/demo requirement.

**Executable children:** 31.A, 31.B, 31.C
...
**SPEC scope:** SPEC §3.1–§3.3 main contribution; §4.4 policy/disclosure; §4.5 feedback; §4.9 Demo scenario; §10.1 AC-02, AC-04–AC-06, AC-09, AC-13, AC-17, AC-20, AC-26–AC-28, AC-31; §10.4 mechanism demo; Harness course mechanism-demo requirement.

**Executable children:** 32.A, 32.B, 32.C
...
**SPEC scope:** SPEC §5.4 evidence; §8.2 local distribution; §8.4 `wheel-build-smoke`; §9 package choice; §10.1 AC-08, AC-10–AC-11, AC-24, AC-26, AC-29–AC-30; §10.3 package smoke; course distribution requirement.

**Executable children:** 33.A, 33.B
...
**SPEC scope:** SPEC §1.4.1/§1.4.5; §4.5 Docker checks; §4.9 Demo; §5.5–§5.6; §6.4 shared core; §8.2–§8.4; §9; §10.1 AC-04, AC-09, AC-12, AC-19–AC-20, AC-24–AC-25, AC-30; §10.3 OCI smoke.

**Executable children:** 34.A, 34.B
...
**SPEC scope:** SPEC §5.4 NFR-OBS; §5.5 release credentials; §8.4 in full; §9 CI choice; §10.1 AC-10–AC-12, AC-24, AC-30; §10.3 GitHub Actions/GitLab/package/image evidence; course common requirements for GitHub Actions on every push and `.gitlab-ci.yml` `unit-test`.

**Executable children:** 35.A, 35.B, 35.C
...
**SPEC scope:** SPEC §5.4–§5.6; §8.2–§8.4; §10.1 AC-10–AC-12, AC-24, AC-30; §10.3 package/public smoke; course CI/CD record and accessible WebUI URL deliverables.

**Executable children:** 36.A, 36.B, 36.C

**Aggregate completion condition:** All listed children are completed according to the canonical DAG, and all child-owned verification and review gates have passed. All child-owned external outcomes are terminal and confirmed; any absent, non-terminal, or failed external state leaves this Milestone incomplete. This Milestone is descriptive/aggregate only and owns no files, APIs, dependencies, schedule, branch/worktree, status, implementation, tests, verification procedure, review procedure, or evidence.
...
**SPEC scope:** SPEC §1.6; §5.3–§5.6; §8.1–§8.4; §10.1 AC-01–AC-31; §10.3; §11.3; course required artifacts, process evidence, README, CI/CD, WebUI URL, and reflection rules; `AGENTS.md` final-report rules.

**Executable children:** 37.A, 37.B, 37.C

**Aggregate completion condition:** All listed children are completed according to the canonical DAG, and all child-owned verification and review gates have passed. Task 37.C records a passing delivery-readiness outcome, including the student-authored reflection check required by the Goal. This Milestone is descriptive/aggregate only and owns no files, APIs, dependencies, schedule, branch/worktree, status, implementation, tests, verification procedure, review procedure, or evidence.
...
**SPEC scope:** SPEC §2 US-02 and US-06–US-08; §4.6 recovery; §4.7 FR-MEM; §4.8 FR-CRED; §4.9 local mode; §5.3–§5.6; §7 MemoryEntry/AuditEvent/PersistenceTransaction; §8.1–§8.2; §10.1 AC-08, AC-14, AC-16, AC-21–AC-24, AC-29; §10.3 local, Windows, and recovery verification.

**Executable children:** 38.A, 38.B, 38.C, 38.D, 38.E, 38.F, 38.G
...
`PlanAuditResultV1` is one deterministic UTF-8 JSON object with exactly one final LF and no extra top-level or nested fields. JSON object key order is normative for canonical serialization. Its exact top-level key order and types are:

1. `auditContractVersion`: JSON string, exactly `PlanAuditContractV1`.
2. `inputIdentities`: JSON object with exactly `plan` then `spec`; each value is a JSON string in canonical absolute Windows-path form. Resolve the supplied path against the verifier process working directory using Windows path rules, eliminate `.` and `..`, replace every `\` with `/`, uppercase the drive letter, require the form `^[A-Z]:/`, and omit a trailing `/` for these file paths. Thus both implementations emit identities such as `D:/code/VesperCode/SPEC.md`, independent of slash spelling in the CLI input.
3. `verifierSourceSha256`, `planCompleteFileSha256`, and `specSha256`: three JSON strings in that exact order, each exactly 64 lowercase hexadecimal characters.
4. `planSemanticDigestV1`: a JSON string of exactly 64 lowercase hexadecimal characters when derivable, otherwise JSON `null`; `null` forces `FAIL`.
5. `metrics`: a JSON object whose values are non-negative safe-integer JSON numbers. Its exact 29-key order is `aggregateMilestones`, `executableTasks`, `dottedExecutableTasks`, `retainedIntegerTasks`, `dagRows`, `dagEdges`, `dagRoots`, `dagReachable`, `dagCycles`, `dependencyWaves`, `scheduledExecutables`, `ownershipTaskRows`, `expandedOwnedPaths`, `duplicatePrimaryOwners`, `sameWaveOwnershipConflicts`, `storageClassificationRows`, `sqliteTables`, `migrations`, `coverageUS`, `coverageFR`, `coverageNFR`, `coverageAC`, `testEnvironments`, `releaseExecutables`, `executableNotStarted`, `executableNotYetExecuted`, `documentDraft`, `demoSharedModules`, and `demoProhibitedPrefixes`.
6. `mechanicalIssues` then `semanticIssues`: two JSON arrays of JSON strings. Each string has the exact form `<UPPER_SNAKE_CASE_CODE>: <non-empty detail>`; emitted occurrences are retained and sorted ascending by their raw UTF-8 byte sequences.
7. `projectionTests`: a JSON array of exactly 14 JSON objects. Every object has exactly `name` (JSON string), `expectation` (JSON string enum `PRESERVE`, `CHANGE`, or `REJECT`), then `passed` (JSON boolean), in that key order. Array order and required `(name, expectation)` pairs are exactly: `(executable-status, PRESERVE)`, `(executable-checkbox, PRESERVE)`, `(long-completion-evidence, PRESERVE)`, `(goal, CHANGE)`, `(dependency, CHANGE)`, `(interface, CHANGE)`, `(command-review, CHANGE)`, `(matrix-gate, CHANGE)`, `(missing-formal-boundary, REJECT)`, `(duplicate-formal-boundary, REJECT)`, `(missing-dag-boundary, REJECT)`, `(duplicate-dag-boundary, REJECT)`, `(utf8-bom, REJECT)`, and `(bare-cr, REJECT)`.
8. `verdict`: JSON string enum `PASS` or `FAIL`.

Verifier-private parser, governance-negative, and result-schema self-tests run fail-closed, but their individual records never appear as result fields and are not part of A/B canonical comparison; a failed private self-test is represented only by a canonical issue string and therefore forces `FAIL`.
